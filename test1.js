...
console.log("6) Indexy największej wartości: ");
for (let i = 1; i < valueArray6.length; i++) {
...
// 1) Lata przestępne: 2000
// 2) 7 silnia = 5040
// 3) Suma liczb nieparzystych to: 37
// 4) Największa liczba to: 98
//    Najmniejsza liczba to: 1
// 5) Najdłuższy napis to: Politechnika
// 6) Indexy największej wartości:
//    5
//    9
//    11
